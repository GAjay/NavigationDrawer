package com.ajay.navigationdrawer.widget;
...
import com.ajay.navigationdrawer.R;
...
public class AnimNavigationDrawer extends RelativeLayout{
    ...
    public AnimNavigationDrawer(Context context) {
        super(context);
    }
    ...
    public AnimNavigationDrawer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.AnimNavigationDrawer,
                0, 0);
        setAttributes(a);
        a.recycle();
    ...
    protected void setAttributes(TypedArray attrs){
        ...
        setAppbarColor(attrs.getColor(R.styleable.AnimNavigationDrawer_appbarColor,getResources().getColor(appbarColor)));
        setAppbarTitleTextColor(attrs.getColor(R.styleable.AnimNavigationDrawer_appbarTitleTextColor,getResources().getColor(appbarTitleTextColor)));
        setMenuiconTintColor(attrs.getColor(R.styleable.AnimNavigationDrawer_HamMenuIconTintColor,getResources().getColor(menuIconTintColor)));
        setMenuItemSemiTransparentColor(attrs.getColor(R.styleable.AnimNavigationDrawer_HamMenuItemSemiTransparentColor,getResources().getColor(menuItemSemiTransparentColor)));
        setNavigationDrawerBackgroundColor(attrs.getColor(R.styleable.AnimNavigationDrawer_navigationDrawerBackgroundColor,getResources().getColor(navigationDrawerBackgroundColor)));
        setPrimaryMenuItemTextColor(attrs.getColor(R.styleable.AnimNavigationDrawer_navigationDrawerBackgroundColor,getResources().getColor(primaryMenuItemTextColor)));
        setSecondaryMenuItemTextColor(attrs.getColor(R.styleable.AnimNavigationDrawer_secondaryMenuItemTextColor,getResources().getColor(secondaryMenuItemTextColor)));
        setAppbarTitleTextSize(attrs.getDimension(R.styleable.AnimNavigationDrawer_appbarTitleTextSize,20));
        setPrimaryMenuItemTextSize(attrs.getDimension(R.styleable.AnimNavigationDrawer_primaryMenuItemTextSize,20));
        setSecondaryMenuItemTextSize(attrs.getDimension(R.styleable.AnimNavigationDrawer_secondaryMenuItemTextSize,20));
        setMenuIconSize(attrs.getDimension(R.styleable.AnimNavigationDrawer_HamMenuIconSize,20));
